...
export default class DeleteStore extends Component {
    ...
    handleDelete = () => {
        axios
            .delete(`Stores/DeleteStore/${this.props.deleteId}`)
            .then((result) => {
                ...
                <Modal id='popup'
                    ...
                    <Modal.Content><h4 class='delete'> Are you sure?</h4>
                        <ModalActions>
                            ...
                            <Button color='red' icon labelPosition="right" onClick={this.handleDelete}>delete
                            <Icon name='remove' labelPosition='right' /></Button>
                        </ModalActions>
                    </Modal.Content>
                </Modal>
            </div>);
